  ...
  useEffect(() => {
    if (productId) {
      const product = data.find(
        (item) => item.documentId.toString() === productId
      );
        ...
        <h2 className="flex items-center text-[16px]  font-bold">
          ...
          <span>
            <img
              ...
              src="https://egypt.kfc.me/assets/top-deals-b9351756.png"
            />
          </span>
        </h2>
        <Link
          href={"/product"}
          className="text-[#007aff] font-bold flex items-center"
        >
          {" "}
          View All
        ...
        {data.map((item) => {
          return (
            ...
            >
              ...
              <div>
                <p className="text-[12px] my-[10px] text-[#6a6e7b] leading-none h-[24px]">
                  {item.description}
                </p>
              </div>
              <div className="text-center bg-[#f1f3f6] rounded-md mb-[20px]">
                <p className="py-[10px] text-[12px] font-extrabold text-[#393f52]">
                  {item.price} EGP
                </p>
              </div>
