    ...
    <div className='bg-[#393f52] text-white py-[30px] relative'>
        <div className='container'>
            <div className='flex flex-col justify-center items-center'>
                <div className=''>
        <a href="#" className="flex flex-col justify-center text-white text-xl font-bold">    
          ...
          D
            ...
            <div>
                    <ul className='flex justify-center'>
                      <li className='px-[20px] text-[25px]'></li>
                    </ul>
            </div>
...
>
  <rect width="15.6923" height="17" fill="#fff" />
  <rect x="22.2307" width="15.6923" height="17" fill="#fff" />
  <rect x="44.4614" width="15.6923" height="17" fill="#fff" />
</svg></div>
        </div>
    </div>
  )
